...
const Swap = ({nativeToken,transferNativeToken}) => {
  ...
  return <div class="swap-area bg-color-3 fix area-padding">
    <div class="container">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6">
          <div class="swap-inner">
            <div class="swap-token left-headline">
              ...
              <h2>
                You can swap{" "}
                <span class="color-text-bold">Graphbit token</span>
                anytime
              </h2>
             <p>
             Blockchain enthusiasts and participants can actively shape the landscape by choosing projects that align with their values and contributing meaningfully to their development{" "}
             </p>
            </div>
          </div>
        </div>
                      ...
                      <li>
                        ...
                        {/* <div class="notification-area left-part"> */}
                          <div class="notification-header">
                            <span class="set-text"></span>
                            <div class="swap-set">
                              <span>Find detail of our ERC20 Native token</span>
                              <ul>
                                <li>
                            ...
                            <div class="swap-set slipege">
                              ...
                              <ul>
                                <li>
                                  <a>
                                    Bal:{nativeToken?.balance}
                                  </a>
                                </li>
                                <li>
                                  <a>
                                    Dec:{nativeToken?.decimals}
                                  </a>
                                </li>
                              </ul>
                            </div>
                      ...
                      <li>
                        ...
                        {/* <div class="notification-area side-part">
                          <div class="author-body text-center">
                            <span>
                              Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet minus vitae voluptatibus perspiciatis eveniet fugit repellendus vero quis ullam nostrum.
                              <br />
                              <a href="#">Buy Token</a>
                            </span>
                          </div>
