          ...
          <div class="col-xl-6 col-lg-6 col-md-8">
            <div class="login-form signup-form">
              ...
              <div id="contactForm" class="log-form">
                <input type="text" id="name" class="form-control" placeholder="address" required onChange={(e)=>handleTokenInfo("address",e)}/>
                <input type="text" id="name" class="form-control" placeholder="amount" required onChange={(e)=>handleTokenInfo("tokenNo",e)}/>
                <button
